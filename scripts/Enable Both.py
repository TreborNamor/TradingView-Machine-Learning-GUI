...
max_stoploss_value = 10
min_takeprofit_value = 0
max_takeprofit_value = 20

decimal_place = 2  # enter decimal place of values. (Default 2nd decimal place)
max_attempts = 20  # For example, 20 attempts to find best stop loss and take profit values.
...
def run_script(driver):
    ...
    while count < max_attempts:
        ...
        try:
            ...
            click.both_inputs(stoploss_value, takeprofit_value, wait)
    ...
    click.both_inputs(profits[best_key][1], profits[best_key][3], wait)
    time.sleep(.5)
