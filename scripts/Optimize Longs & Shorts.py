...
max_long_stoploss_value = 15
min_long_takeprofit_value = 0
max_long_takeprofit_value = 30

min_short_stoploss_value = 0
max_short_stoploss_value = 15
...
def run_script(driver):
    ...
    while count < max_attempts:
        count += 1
        long_stoploss_value = round(random.uniform(min_long_stoploss_value, max_long_stoploss_value), decimal_place)
        long_takeprofit_value = round(random.uniform(min_long_takeprofit_value, max_long_takeprofit_value), decimal_place)
        short_stoploss_value = round(random.uniform(min_short_stoploss_value, max_short_stoploss_value), decimal_place)
        short_takeprofit_value = round(random.uniform(min_short_stoploss_value, max_short_stoploss_value), decimal_place)
        ...
        try:
            ...
            click.all_inputs(long_stoploss_value, long_takeprofit_value, short_stoploss_value, short_takeprofit_value, wait)

            # extract the net profit percentage.
            get.net_all(long_stoploss_value, long_takeprofit_value, short_stoploss_value, short_takeprofit_value, wait)
    ...
    click.all_inputs(profits[best_key][1], profits[best_key][3], profits[best_key][5], profits[best_key][7], wait)
    time.sleep(.5)
