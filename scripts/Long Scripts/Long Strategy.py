...
def run_script(driver):
    ...
    # Searching for best stop loss and take profit for your strategy.
    count = 0
    while count < max_attempts:
        ...
        try:
            ...
            click.long_inputs(stoploss_value, takeprofit_value, wait)
    ...
    click.long_inputs(profits[best_key][1], profits[best_key][3], wait)
    time.sleep(.5)
