...
class Backtester:
    ...
    def calculate_profit(buy_signals: list, sell_signals: list) -> float:
        """
            Calculates the Calmar ratio for the given buy and sell signals and market returns.
            ...
            Returns:
                Tuple[float, float, float]: A tuple containing the negative Calmar ratio, Calmar ratio, and profit.
        """
