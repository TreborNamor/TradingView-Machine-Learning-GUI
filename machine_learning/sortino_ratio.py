...
class Backtester:
    ...
    def __init__(self, dataframe):
        """
            ...
            Attributes:
                ...
                highest_profit (float): The highest Sortino ratio obtained during optimization.
                best_profit (float): The profit corresponding to the highest Sortino ratio obtained during optimization.
        """
    ...
    def calculate_sortino_ratio(buy_signals: list, sell_signals: list, risk_free_rate=0.0) -> float:
        """
            Calculate the Sortino ratio for a trading strategy.
    ...
    def calculate_profit(buy_signals: list, sell_signals: list) -> float:
        """
            Calculates the Sortino ratio for the given buy and sell signals and market returns.
            ...
            Returns:
                Tuple[float, float, float]: A tuple containing the negative Sortino ratio, Sortino ratio, and profit.
        """
    ...
    def evaluate_strategy(self, dataframe: pd.DataFrame) -> tuple:
        """
            Evaluate the trading strategy by calculating the Sortino ratio and profit based on the buy and sell signals and market returns.

            Args:
                dataframe (pd.DataFrame): The data on which the trading signals will be evaluated.
            Returns:
                A tuple of three values: the negative Sortino ratio, the positive Sortino ratio, and the profit percentage.
        """
    ...
    def find_optimal_parameters(self, params: list) -> float:
        """
            ...
            Returns:
                The negative Sortino ratio of the trading strategy.
        """
        ...
        rounded_sortino = round(sortino_ratio, 4)
    ...
    def optimize_trading_strategy(self, find_optimal_parameters, search_space):
        """
            ...
            Returns:
                A tuple of three values: the best parameters for the trading strategy, the best Sortino ratio, and a message displaying the best parameters and evaluation metrics.
        """
        result = gp_minimize(
        ...
        if not best_dataframe.empty:
            ...
            message = "Best parameters: rsi_buy_threshold={}, rsi_sell_threshold={}, sortino_ratio={}, profit={}%".format(
                best_params[0], best_params[1], round(best_sortino, 4), round(best_profit, 2))
        else:
